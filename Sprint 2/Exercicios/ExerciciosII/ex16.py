# EX16 - Crie uma classe chamada Pessoa, com um atributo privado chamado nome 
...
# Lembre-se que o acesso ao atributo privado deve ocorrer somente através dos
# métodos definidos, nunca diretamente.  Você pode alcançar este comportamento

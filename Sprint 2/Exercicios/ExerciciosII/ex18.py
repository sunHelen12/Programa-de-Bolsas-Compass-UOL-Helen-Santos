# EX18 - Crie uma classe Ordenadora que contenha um atributo listaBaguncada e que contenha 
...
# como listaBaguncada a lista [3,4,2,1,5] e instancie um outro objeto, decrescente
...
# segundo objeto, use o método ordenacaoDecrescente.
